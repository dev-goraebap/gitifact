...
const colors = { feature: 'default', requirement: 'teal', design: 'orange', wiki: 'pink' } as const satisfies Record<Kind, string>;

/** The kind of a document — feature, requirement, design or wiki page — as a small token. */
export function KindToken({ kind }: { kind: Kind }) {
  useLanguage();
  const labels: Record<Kind, string> = { feature: t('kind.feature'), requirement: t('kind.requirement'), design: t('kind.design'), wiki: t('kind.wiki') };
