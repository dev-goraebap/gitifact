...
export type ProductProps = {view:'history'|'features'|'contributors'|'product'|'guides';featureId?:string|undefined;email?:string|undefined;documentId?:string|undefined;search:ProductSearch;change:(s:ProductSearch,replace?:boolean)=>void};
