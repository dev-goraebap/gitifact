...
export type ProductProps = {view:'history'|'features'|'contributors';featureId?:string|undefined;email?:string|undefined;search:ProductSearch;change:(s:ProductSearch,replace?:boolean)=>void};
