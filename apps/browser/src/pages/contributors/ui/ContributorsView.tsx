import type { BrowserSessionV3, BrowserSpecsV7, SpecFeature } from '@gitifact/contracts';
...
function ContributorGrid({people,features,search}: {people:Contributor[];features:SpecFeature[];search:RecordSearch}) {
  useLanguage();
