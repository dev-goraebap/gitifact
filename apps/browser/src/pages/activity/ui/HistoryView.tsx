 ...
 */
export function HistoryView({features,search,change,session,head}: {features:SpecFeature[];search:RecordSearch;change:(s:RecordSearch)=>void;session:BrowserSessionV3;head:string|null}) {
  useLanguage();
