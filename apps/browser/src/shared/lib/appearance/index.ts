...
export const paletteColors: Record<Exclude<Palette, 'stone'>, PaletteColors> = {
  ...
  olive: { body: ['#f5f5f1', '#10110d'], surface: ['#fdfdfc', '#191a15'], card: ['#ffffff', '#22241d'], muted: ['#edede7', '#292b23'],
    accent: ['#5e6b18', '#92a245'], tint: ['#ecf3d5', '#2c3112'], text: ['#1d1e16', '#f2f2ee'], secondary: ['#5b5c4f', '#abac9e'], border: ['#e3e3dd', '#ffffff1a'], inputBorder: ['#cecfc6', '#ffffff33'], onAccent: ['#fafeef', '#101304'] },
...
// Stone is the shipped theme; these four values only draw its card on the settings page.
export const stonePreview: Pick<PaletteColors, 'body' | 'surface' | 'accent' | 'text'> = { body: ['#f3f3f5', '#111015'], surface: ['#ffffff', '#1b1b1f'], accent: ['#25252a', '#f3f3f5'], text: ['#25252a', '#f3f3f5'] };
