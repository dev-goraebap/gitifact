...
export const updateV3 = z.discriminatedUnion('ok', [
  z.strictObject({ contract: z.literal('update'), version: z.literal(3), ok: z.literal(true),
  ...
  z.strictObject({ contract: z.literal('update'), version: z.literal(3), ok: z.literal(false), error: z.strictObject({ code: z.string(), message: z.string() }) }),
]);
export type UpdateV3 = z.infer<typeof updateV3>;
