...
test('current schema has only schemaVersion and baseline; unknown schemas and legacy spec labels fail', () => {
  ...
  // The 0.7 convention, the one a migration starts from, points at the migration prompt.
  assert.throws(()=>parseManagedConfig('{"schemaVersion":2,"baseline":{"kind":"empty"}}'),{code:'UNSUPPORTED_SCHEMA',message:/schemaVersion 2.*마이그레이션 프롬프트/});
