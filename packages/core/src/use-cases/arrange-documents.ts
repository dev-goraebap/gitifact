import type { DesignDoc, Doc, FeatureDoc, RequirementDoc, WikiDoc } from '../domain/document.js';
 ...
 * folder name, and the wiki by path. The list command and the browser both show this shape.
 */
export function arrangeDocuments(documents: readonly Doc[]): ArrangedDocuments {
  ...
  return { features, wiki: wiki.sort(byPath), orphans };
}
