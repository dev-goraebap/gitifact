...
sources:
  ...
  - title: 결정 0004. 모노레포와 패키지 경계
    path: ../../wiki/adr/0004-monorepo-and-package-boundaries.md
  - title: 결정 0005. 로컬 실행과 읽기 전용 브라우저
    path: ../../wiki/adr/0005-local-first-read-only-browser.md
  - title: 결정 0006. 에이전트 지침의 단일 원본
    path: ../../wiki/adr/0006-single-source-agent-guidance.md
---
