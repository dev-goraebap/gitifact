...
3. 조건: 블록이 있는 프로젝트에 참여한 팀원의 환경에 gitifact 명령이 없습니다.
   기대 동작: 블록은 전역 설치를 요구하지 않고 블록 버전의 npx 실행을 안내합니다. 같은 버전의 프로젝트 설치본이 있으면 사용하고, 없으면 npm 캐시에 받아 실행합니다. 실행·다운로드 권한이 막히면 필요한 승인을 요청하고 원인을 알리며, 문서 ID 발급·검사·커밋을 대신하거나 완료했다고 보고하지 않습니다.
