...
> 다음 MVP는 작업 중 명세를 자동 정리하고 커밋된 최종 버전을 Git으로 추적하는 방향입니다. 승인·note는 MVP에서 제외하고, 요구사항 이력·제품 기능·기여자 세 화면을 제공합니다. 개발 CLI는 새 형식을 지원하며 개발 브라우저에서 세 화면을 실제 Markdown·Git 데이터로 읽을 수 있습니다. [전환 계획](docs/mvp-transition.md)을 참고하세요.

## 에이전트에게 시작을 맡기세요

아래는 새 `schemaVersion: 1` 저장 규약을 지원하는 개발 빌드용 도입 프롬프트입니다. npm의 0.3.0에는 아직 적용되지 않았습니다.
